...
namespace ParticleForm
{
    ...
    /// </summary>
    public class PanelDrawer : Drawer
    {
        Pen pen;
        Vector3[] p = new Vector3[10];

        public PanelDrawer(float scale) : base(scale) { pen = new Pen(Color.Black, 2); }

        public PanelDrawer(Pen p, float scale) : base(scale) { this.pen = p; }
